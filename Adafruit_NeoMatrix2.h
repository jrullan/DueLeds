...
#ifndef _ADAFRUIT_NEOMATRIX2_H_
#define _ADAFRUIT_NEOMATRIX2_H_
...
class Adafruit_NeoMatrix2 : public Adafruit_GFX, public Adafruit_NeoPixel2 {

 public:

  // Constructor for single matrix:
  Adafruit_NeoMatrix2(int w, int h, uint8_t *leds_data, uint8_t pin = 6,
    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_ROWS,
    uint8_t ledType    = NEO_GRB + NEO_KHZ800);

  // Constructor for tiled matrices:
  Adafruit_NeoMatrix2(uint8_t matrixW, uint8_t matrixH, uint8_t tX, uint8_t *leds_data,
